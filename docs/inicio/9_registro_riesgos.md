...
| **R-02** | **Incumplimiento de prácticas Git/GitHub** | 4.2 Control | [cite_start]Falta de costumbre en el uso de ramas, PRs o commits semánticos por parte del equipo[cite: 22, 23, 24]. | 3 | 2 | **6** | 1 | Activo | **Evitar:** Implementar política de bloqueo en la rama `main`. Nadie sube código sin revisión. | Tony |
